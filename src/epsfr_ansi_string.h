...
public:
	...
	static int fast_count_tokens(char* str, bool count_empty, const char* delims);
	...
	static vector<char*>* copy_tokens_2_strs(t_string_tokens* toks, int tok_i_first, int tok_i_last);
	...
	static void replace_avoid_list(char* str, const char* avoided_char_list, char char_to_replace);
	...
	void concat_string(const char* string);
